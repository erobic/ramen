...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='/hdd/robik/VQA_features')
    parser.add_argument('--split', type=str, choices=['trainval', 'test'])
    args = parser.parse_args()

    infile = args.data_root + f'/{args.split}_36/{args.split}_resnet101_faster_rcnn_genome_36.tsv'
    train_data_file = f'{args.data_root}/features/{args.split}.hdf5'
    ...
    with open(os.path.join(args.data_root, 'features', f'{args.split}_ids_map.json'), 'w') as f:
